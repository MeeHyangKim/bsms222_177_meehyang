...
Examining these heights carefully, we see two common mistakes: entries in ```x.y``` with ```x``` and ```y``` representing feet and inches, respectively, which turn out to be too small. Some of the even smaller values, such as 1.6, could be entries in meters.
