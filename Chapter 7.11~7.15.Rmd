...
```{r}
murders %>% ggplot(aes(population, total)) + geom_label(aes(population, total,label=abb))
```
...
```{r}
murders %>% ggplot(aes(population, total)) + geom_label(aes(population, total,label=abb),color="blue")
```
...
```{r}
murders %>% ggplot(aes(population, total)) + geom_label(aes(population, total,label=abb),col=region)
```
